"""sneakerheadz_19207 URL Configuration
...
admin.site.site_header = "SneakerHeadz"
admin.site.site_title = "SneakerHeadz Admin Portal"
admin.site.index_title = "SneakerHeadz Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="SneakerHeadz API",
        default_version="v1",
        description="API documentation for SneakerHeadz App",
    ),
    public=True,
